// app/events/tech-conclave/page.tsx
'use client'

import { motion } from 'framer-motion'
import Link from 'next/link'

export default function TechConclavePage() {
  return (
    <section className="pt-32 pb-20 min-h-screen bg-gradient-to-b from-black to-purple-900/20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Tech Conclave 2026</h1>
